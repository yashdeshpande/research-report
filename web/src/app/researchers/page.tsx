  ...
  return (
    <div className="min-h-screen px-8 py-10">
      <div className="mx-auto max-w-5xl space-y-8">
        {/* Header */}
        <div>
          <h1 className="text-4xl font-bold tracking-tight text-slate-900">Researchers</h1>
          <p className="mt-2 text-slate-600">
            Manage team members who create and collaborate on research.
          </p>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <section className="lg:col-span-1">
            <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="text-lg font-semibold text-slate-900">New Researcher</h2>
            ...
            <div className="rounded-lg border border-slate-200 bg-white shadow-sm">
              ...
              {isLoading ? (
                ...
                <div className="px-6 py-8 text-center text-sm text-slate-500">
                  {items.length === 0 ? "No researchers yet." : "No researchers match your search."}
                </div>
              ) : (
